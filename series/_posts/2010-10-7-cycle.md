...
The cycle series component allows the creation of cycle plots which can help identify cyclical patterns nested in time series data. The following example shows some arbitrary sales data grouped by weekday:
