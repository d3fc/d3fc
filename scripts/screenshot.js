...
const capture = (url, file, browser) => async () => {
    const screenshot =
        path.resolve('screenshots', file.substr(0, file.length - 5)) + '.png';
