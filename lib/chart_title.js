...
var nav = createPlotArea(dataSeries_Large, '#chart_title_nav', false, false, false, false, true);
...
nav.plotArea.append("g")
    ...
    .call(viewport)
    .selectAll("rect")
    .attr("height", nav.layout.getPlotAreaHeight());
...
chart.dateScale.domain([
    dataSeries_Large[dataSeries_Large.length - 30].date,
