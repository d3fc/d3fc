...
const getWebglSeries = () => fc.seriesWebglPoint()
    ...
    .decorate(program => {
        ...
        //     .appendBody(fc.vertexShaderSnippets.positionalColor.body);
...
const getCanvasSeries = () => fc.seriesCanvasPoint()
    .crossValue(crossValue)
    .mainValue(mainValue)
    .type(d3.symbolSquare)
    .size(size);
...
const getCanvasChart = () => getChart()
    .canvasPlotArea(getCanvasSeries());
