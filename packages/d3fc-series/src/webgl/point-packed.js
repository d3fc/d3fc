...
export default () => {
    ...
    const packedAttribute = webglElementAttribute()
        .size(4);

    const draw = webglSeriesPointPacked()
        .packedAttribute(packedAttribute);
    ...
    const point = (data) => {
        ...
        packedAttribute.value((d, i) => d).data(data);
        ...
        draw.xScale(xScale.webglScale)
            ...
            .type(webglSymbolMapper('circlePacked'))
