...
describe('geometricBrownianMotion', () => {
    it('should output the correct number sequence', () => {
        ...
        const gbm = geometricBrownianMotion().steps(5).random(normal());
        ...
        expect(gbmData).toEqual([
            10, 10.563051249613967, 10.862390962256633, 11.473999242766038,
            11.799153741691457, 12.463506567556125,
        ]);
    });
