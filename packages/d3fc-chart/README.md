...
<a name="cartesian_scaleByDevicePixelRatio" href="#cartesian_scaleByDevicePixelRatio">#</a> *cartesian*.**scaleByDevicePixelRatio**(*value*)

If the boolean *value* is specified, sets whether the Canvas / WebGL should be scaled based on the resolution of the display device, and returns the Cartesian chart. If *label* is not specified, returns the current value.
