...
type NotStartsWith<K, TPrefix extends string> = K extends `${TPrefix}${infer _}`
    ? never
    : K;

type OmitPrefixes<T> = {
    [K in keyof T as NotStartsWith<K, 'range' | 'tickFormat'>]: T[K];
};
...
export type CartesianChart<XScale, YScale> = {
     ...
     */
    canvasPlotArea(
        component: CanvasPlotAreaComponent,
     ...
     */
    svgPlotArea(
        component: SvgPlotAreaComponent,
    ): CartesianChart<XScale, YScale>;
     ...
     */
    webglPlotArea(
        component: WebglPlotAreaComponent,
    ): CartesianChart<XScale, YScale>;
...
export default function Cartesian<
    XScale extends Scale | undefined,
    YScale extends Scale | undefined,
>(
    configuration: CartesianChartConfigurationParameter<XScale, YScale>,
