...
describe('line', () => {
    ...
    it('should work with continuous scales for svg', () => {
        ...
        const svgLine = annotationSvgLine().xScale(xScale).yScale(yScale);

        select('svg').datum([30]).call(svgLine);
    });
    ...
    it('should work with continuous scales for canvas', () => {
        ...
        const canvasLine = annotationCanvasLine().xScale(xScale).yScale(yScale);
