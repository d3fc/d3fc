...
describe('tradingDay', () => {
    describe('totalTradingMillisecondsBetween', () => {
        ...
        it('should return 2 ms - one at start and one at the end of the day', () => {
            expect(
                tradingDay(
                    [['0:0:0.1', '23:59:59.998']],
                    localDateTimeUtility,
                ).totalTradingMillisecondsBetween(
                    new Date(2018, 0, 1),
                    new Date(2018, 0, 1, 23, 59, 59, 999),
                ),
            ).toBe(2);
            expect(
                tradingDay(
                    ...
                    new Date(Date.UTC(2018, 0, 1)),
                    new Date(Date.UTC(2018, 0, 1, 23, 59, 59, 999)),
                ),
            ).toBe(2);
        });
