(function(d3, fc) {
    ...
    describe('fc.utilities.extent', function() {
        ...
        it('should compute extents based on the supplied fields', function() {
            ...
            var extents = fc.utilities.extent(data, ['high']);
            expect(extents[0]).toEqual(6);
            expect(extents[1]).toEqual(15);

            extents = fc.utilities.extent(data, ['high', 'low']);
        ...
        it('should support arrays of arrays', function() {
            ...
            var extents = fc.utilities.extent([data, data2], 'high');
            expect(extents[0]).toEqual(6);
        ...
        it('should support accessor functions', function() {
            ...
            var extents = fc.utilities.extent(data, [function(d) { return d.high + 100; }]);
