...
function renderChart() {
    ...
    const mergedData = data.map((d, i) => ({ ...d, bollinger: bollingerData[i] }));
    ...
    const yExtent = fc.extentLinear()
        .accessors([d => d.bollinger.upper, d => d.high, d => d.bollinger.lower, d => d.low]);
    ...
    const bollingerBands = function () {
        ...
        const bollingerMulti = fc.seriesSvgMulti()
            ...
            .decorate(g => {
                g.enter()
                    .attr('class', (_, i) => 'multi bollinger ' + ['area', 'upper', 'lower', 'average'][i]);
            });
